...
P &
		  ...
		  \begin{tikzpicture}
			  \node (a) {$\displaystyle y(t) = K  u(t), \quad A(\omega) = K$};
...
I &
           \begin{tikzpicture}[thick] \draw[<->] (0,1) |- (1.5,0); \draw[red!80] (0,0) -- (1.4,0.7); \end{tikzpicture} &
		   \begin{tikzpicture}
			   \node (a) {$y(t) = \int_{0}^{t} u(t)dt, \quad A(\omega) = \frac{1}{T_I \omega}$};
			   \node [below=-1mm of a] {$G=\frac{1}{T_I s}, \quad \varphi(\omega)= -\frac{\pi}{2}$};
		   \end{tikzpicture}
		   &
				    \begin{tikzpicture}[thick]
					    \draw[->] (0,-0.7) -- (0,0.7) node[right] {$\Im$};
...
\begin{scope}[xscale=40/100, yscale=2/100] 
	...
	\node[xshift=0mm, yshift=7mm] (a) {$1/T_I$};
	\node[xshift=0mm, yshift=-1mm] (b) {};
	\draw[very thick, red!80] (a) to (b);
\end{scope} 
...
D &
		   ...
		   \begin{tikzpicture}
			   \node (a) {$\displaystyle y(t) = u'(t), \quad A(\omega) = T_D \omega$};
			   \node [below=-1mm of a] {$\displaystyle G=s T_D, \quad \varphi(\omega) = \frac{\pi}{2}$};
		   \end{tikzpicture}
		   &
				    \begin{tikzpicture}[thick]
					    \draw[->] (0,-0.7) -- (0,0.7) node[right] {$\Im$};
...
\begin{scope}[xscale=40/100, yscale=2/100] 
	\UnitedB \semilog{-2}{3}{-30}{20} % xi=0.1 
	\BodeGraph[blue!80,samples=500]{-1.5:1}{-\IntAmp{1}} % D Glied
	\node[xshift=0mm, yshift=7mm] (a) {$1/T_D$};
	\node[xshift=0mm, yshift=-1mm] (b) {};
	\draw[very thick, red!80] (a) to (b);
\end{scope} 
...
\begin{scope}[yshift=-14mm, xshift=3cm,xscale=30/100,yscale=3/220] 
	...
	\BodeGraph[blue!80,samples=500]{-2:3}{-\IntArg{1}} % D Glied
\end{scope} 
\end{tikzpicture}
\\ \hline
PT$_1$ &
	...
	\end{tikzpicture} &
	      \begin{tikzpicture}
		      \node (a) {$\displaystyle T y' + y = u(t), \quad A(\omega) = \frac{1}{\sqrt{1+(T_1 \omega)}}$};
			\node [below=-1mm of a] {$G=\frac{1}{1+T_1s}, \quad \varphi(\omega) = -\arctan(\omega T_1)$};
	      \end{tikzpicture}
	      &
				    \begin{tikzpicture}[thick]
					    \draw[->] (0,-0.7) -- (0,0.7) node[right] {$\Im$};
...
\begin{scope}[xscale=40/100, yscale=2/100] 
	...
	\node[xshift=4mm, yshift=7mm] (a) {$1/T_1$};
...
PT$_2$ &
     \begin{tikzpicture}[thick] \draw[<->] (0,1) |- (1.5,0); \begin{axis}[scale=0.18,domain=0:5,samples=501,axis lines=none, xlabel={}, ylabel={}] \addplot[color=red!80,no marks,thick,smooth] {(1-exp(-x)*cos(10*deg(x)*0.5))}; \end{axis} \end{tikzpicture}  &
	      \begin{tikzpicture}
		      \node (a) { $\frac{y''}{\omega_{0}^{2}} \small{+}  \frac{2 Dy'}{\omega_{0}} \small{+} y = u(t) $};
			\node [below=-1mm of a] (b) {$G=\frac{1}{1+\frac{2 D}{\omega_{0}} s+\frac{1}{\omega_{0}^{2}} s^{2}}$};
			\node [below of=b] (c) {$A( \omega) =\frac{1}{\sqrt{\left(1-\left(T_1\right)^{2}\right)^{2}+\left(2 \cdot D T_2\right)^{2}}}$};
...
\begin{scope}[xscale=40/100, yscale=2/100] 
	\UnitedB \semilog{-2}{3}{-30}{20} % xi=0.1 
	\BodeGraph[blue!80, dotted, samples=500]{-2:1.75}{\SOAmp{1}{0.1}{10}} % PT2 Glied
	\BodeGraph[blue]{-2:1.75}{\SOAmpAsymp{1}{0.1}{10}} % PT2 Glied
	\node[xshift=4mm, yshift=7mm] (a) {$\omega_0$};
	\node[xshift=4mm, yshift=-1mm] (b) {};
	\draw[very thick, red!80] (a) to (b);
\end{scope} 
...
\begin{scope}[yshift=4mm, xshift=3cm,xscale=30/100,yscale=3/440] 
	...
	\BodeGraph[blue!80, dotted, samples=500]{-2:3}{\SOArg{10}{0.1}{10}} % PT2 Glied
	\BodeGraph[blue!80,samples=500]{-2:3}{\SOArgAsymp{10}{0.1}{10}} % PT2 Glied
\end{scope} 
\end{tikzpicture}
\\ \hline
PT$_t$ &
       \begin{tikzpicture}[thick] \draw[<->] (0,1) |- (1.5,0); \draw[red!80] (0,0) -| (0.7,0.7); \draw[red!80] (0.7,0.7) -- (1.4,0.7); \end{tikzpicture}                                                                  &
	      \begin{tikzpicture}
		      \node (a) {$y(t) = u(t-T_t), \quad A(\omega)=1 $};
			\node [below=-1mm of a] {$G=e^{-sT_t}, \quad \varphi(\omega)=-\omega \cdot T_{t} $};
	      \end{tikzpicture}
	      &
				    \begin{tikzpicture}[thick]
					    \draw[->] (0,-0.7) -- (0,0.7) node[right] {$\Im$};
        ...
        \begin{scope}[xscale=40/100, yscale=2/100] 
        	\UnitedB \semilog{-2}{3}{-30}{20} % xi=0.1 
        	\BodeGraph[blue!80, samples=500]{-2:3}{\RetAmp{10}} % PT1 Glied
        \end{scope} 
        ...
        \begin{scope}[yshift=4mm, xshift=3cm,xscale=30/100,yscale=3/220] 
        	...
        	\OrdBode{30} 
        	\semilog{-2}{3}{-90}{0} % xi=0.1 
        	\BodeGraph[blue!80,samples=500]{-2:3}{\RetArg{.08}} % P Glied
        \end{scope} 
        \end{tikzpicture}
	\\ \hline
...
PID  &
      \begin{tikzpicture}[thick] \draw[<->] (0,1) |- (1.5,0); \draw[red!80] (0,0) -- (0,0.8); \draw[red!80] (0,0.3) -- (1.4,0.7); \end{tikzpicture} &
	      \begin{tikzpicture}
		      \node (a) {\small $y =  u(t) + T_V u'(t) + \frac{1}{T_N}\int_{0}^{t} u(t)dt$};
			\node [below=-1mm of a] (b) {$G=\left(1+\frac{1}{T_{N} s}+T_{V} s\right)u(t)\; dt$};
			\node [below of=b] (c) {$A(\omega) =\frac{1}{\omega  T_{N}} \sqrt{\left(1+\left(\omega \cdot T_{N}\right)^{2}\left(1+\left(\omega \cdot T_{V}\right)^{2}\right)\right)}$};
        ...
        \begin{scope}[xscale=40/100, yscale=2/100] 
        	\UnitedB \semilog{-1}{4}{-10}{40} % xi=0.1 
        	\BodeGraph[blue!80, samples=500]{-1:4}{\PIDAmpAsymp{1}{1}{0.001}} % PT1 Glied
        	\BodeGraph[blue!80, dotted, samples=500]{-1:4}{\PIDAmp{1}{1}{0.001}} % PT1 Glied
        	\node[xshift=0mm, yshift=11mm] (a) {$1/T_N$};
	        \node[xshift=0mm, yshift=-1mm] (b) {};
	        \draw[very thick, red!80] (a) to (b);
	        \node[xshift=12mm, yshift=11mm] (c) {$1/T_V$};
	        \node[xshift=12mm, yshift=-1mm] (d) {};
	        \draw[very thick, red!80] (c) to (d);
        \end{scope} 
        
        \begin{scope}[yshift=4mm, xshift=3.4cm,xscale=30/100,yscale=3/440] 
        	\UniteDegre 
        	\OrdBode{30} 
        	\semilog{-2}{3}{-90}{90} % xi=0.1 
        	\BodeGraph[blue!80,samples=500]{-2:3}{\PIDArgAsymp{1}{1}{0.001}} % P Glied
        	\BodeGraph[blue!80, dotted, samples=500]{-2:3}{\PIDArg{1}{1}{0.001}} % P Glied
        \end{scope} 
        \end{tikzpicture}
...
\paragraph{Frequenzgang}
	\begin{align*}
		...
		%G(i\omega) &= A(\omega) \cdot e^{-i \varphi(i\omega)} \\
